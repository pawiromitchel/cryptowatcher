...
var knownPythFeeds = map[string]struct {
	...
	"SPY":    {feedID: "2b89b9dc8fdf9f34709a5b106b472f0f39bb6ca9ce04b0fd7f2e971688e2e53b", pythSym: "Equity.US.SPY/USD", cap: "$550B"},
	"S&P":    {feedID: "2b89b9dc8fdf9f34709a5b106b472f0f39bb6ca9ce04b0fd7f2e971688e2e53b", pythSym: "Equity.US.SPY/USD", cap: "$550B"},
	"TSLA":   {feedID: "19129e0de5cf1034f71a4857b28290fa8f2e245a4a5ee5b30ca10e755ea7e30d", pythSym: "Equity.US.TSLA/USD", cap: "$685B"},
	"TSLAC":  {feedID: "19129e0de5cf1034f71a4857b28290fa8f2e245a4a5ee5b30ca10e755ea7e30d", pythSym: "Equity.US.TSLA/USD", cap: "$685B"},
	"GOOGL":  {feedID: "0ab8184be5e381b19965d1d6efcf2d7ee6010dd913ea793f18e974eab75c4e97", pythSym: "Equity.US.GOOGL/USD", cap: "$2.05T"},
	"GOOG":   {feedID: "0ab8184be5e381b19965d1d6efcf2d7ee6010dd913ea793f18e974eab75c4e97", pythSym: "Equity.US.GOOGL/USD", cap: "$2.05T"},
	"GOOGLC": {feedID: "0ab8184be5e381b19965d1d6efcf2d7ee6010dd913ea793f18e974eab75c4e97", pythSym: "Equity.US.GOOGL/USD", cap: "$2.05T"},
	"AAPL":   {feedID: "49f6b65eb1de5cfdb87dbcf55b6dbdb69db463eec2e6ecb4408ca672edd80894", pythSym: "Equity.US.AAPL/USD", cap: "$3.45T"},
	"AAPLC":  {feedID: "49f6b65eb1de5cfdb87dbcf55b6dbdb69db463eec2e6ecb4408ca672edd80894", pythSym: "Equity.US.AAPL/USD", cap: "$3.45T"},
	"NVDA":   {feedID: "17b8f9e612cfa8a25c11bc5153246eb7607ecd59392e212b1d3ef12f9e4210e5", pythSym: "Equity.US.NVDA/USD", cap: "$3.12T"},
	"NVDAC":  {feedID: "17b8f9e612cfa8a25c11bc5153246eb7607ecd59392e212b1d3ef12f9e4210e5", pythSym: "Equity.US.NVDA/USD", cap: "$3.12T"},
	"COIN":   {feedID: "8bf932cfa03ec2ffb462c1619cf3992b8d00d23872c6bf58fa8fef0fbef26b7c", pythSym: "Equity.US.COIN/USD", cap: "$55.8B"},
	"COINC":  {feedID: "8bf932cfa03ec2ffb462c1619cf3992b8d00d23872c6bf58fa8fef0fbef26b7c", pythSym: "Equity.US.COIN/USD", cap: "$55.8B"},
	"MSFT":   {feedID: "d97b0a7018cf41f8a846c4f02a5c0b7be2232fb9a7e6b0bf5d2db24c7f07e5c5", pythSym: "Equity.US.MSFT/USD", cap: "$3.08T"},
	"MSFTC":  {feedID: "d97b0a7018cf41f8a846c4f02a5c0b7be2232fb9a7e6b0bf5d2db24c7f07e5c5", pythSym: "Equity.US.MSFT/USD", cap: "$3.08T"},
	"AMZN":   {feedID: "50c67b3bb2cb05f0ce100a94ffe28ecbe005b8ab7611f7c32bf2585f8382c422", pythSym: "Equity.US.AMZN/USD", cap: "$1.95T"},
	"AMZNC":  {feedID: "50c67b3bb2cb05f0ce100a94ffe28ecbe005b8ab7611f7c32bf2585f8382c422", pythSym: "Equity.US.AMZN/USD", cap: "$1.95T"},
	"META":   {feedID: "b6e9a7e04ef4c2b9da703be9e1bf6eb071b7829be6587c69996841d1ebc3c631", pythSym: "Equity.US.META/USD", cap: "$1.32T"},
	"METAC":  {feedID: "b6e9a7e04ef4c2b9da703be9e1bf6eb071b7829be6587c69996841d1ebc3c631", pythSym: "Equity.US.META/USD", cap: "$1.32T"},
	"QQQ":    {feedID: "2b89b9dc8fdf9f34709a5b106b472f0f39bb6ca9ce04b0fd7f2e971688e2e53b", pythSym: "Equity.US.QQQ/USD", cap: "$280B"},
}
...
// FetchPair retrieves market data and 7-day history for equities and tokenized stocks.
func (f *PythFetcher) FetchPair(ctx context.Context, rawInput string) (model.CryptoPair, error) {
	...
	// 2. Fetch 7-day historical prices from Benchmarks API
